...
import static com.android.internal.util.PowerMenuConstants.*;
...
import com.android.internal.util.PowerMenuUtils;
...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    public GlobalActionsDialog(Context context, GlobalActionsManager windowManagerFuncs) {
        ...
        filter.addAction(ACTION_UPDATE_POWER_MENU);
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (ACTION_UPDATE_POWER_MENU.equals(action)) {
                updatePowerMenuActions();
            }
        }
    };
    ...
    protected void updatePowerMenuActions() {
        ...
        final String powerMenuActions = Settings.Secure.getStringForUser(resolver,
